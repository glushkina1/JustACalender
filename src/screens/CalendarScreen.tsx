...
const CalendarScreen = observer(({}) => {
  ...
  const addPeriod = store.addPeriod
  const [modalVisible, setModalVisible] = useState<boolean>(false)
  // const [modalEditPeriodVisible, setModalEditPeriodVisible] = useState<boolean>(false)
  ...
  periods.map(el => console.log('console', el))
  ...
  // useEffect(() => {}, [isDateAvailable])

  const CalendarHeaderHandler = () => {
    return CalendarHeader({ selectedDate, setSelectedDate })
  }

  const keyRender = (selectedDate: Date, isDarkMode: boolean, periods: string[] | never[]) => {
  ...
  const handleDayPress = (day: DateData) => {
    ...
    // checkDateAlreadySelected(day.dateString, periods, setIsDateAvailable)
  }
    ...
    <SafeAreaView style={styles.screenContainer}>
      <View style={styles.calendarContainer}>
        <Calendar
          ...
          markedDates={makeDaysMarked(periods)}
          markingType="period"
